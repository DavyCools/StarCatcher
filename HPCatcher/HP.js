...
function ster(x, y, w, h, vx, vy) {
  ...
  this.Draw = function (ctx) {
    ...
    ctx.rotate(2*RotateTeller*Math.PI/180);
...
var h1 = new heks(window.innerWidth / 2, window.innerHeight / 2, 75, 50);
var sterren = [];
